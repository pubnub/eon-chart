...
If you'd like to supply your own ```Date``` object (or other x value), set ```x_type``` to ```custom```. Then, set ```x_id``` to the x value that appears within your published messages. 
